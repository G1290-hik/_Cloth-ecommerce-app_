...
List<CardItem> itemList1 = const [
  CardItem(
    title: 'And Then There Were None',
    price: "€11.49",
    image: 'assets/images/none.jpg',
    description:
        'A thrilling mystery that takes place on a secluded island where ten strangers are invited and start getting killed one by one.',
  ),
  CardItem(
    ...
    description:
        'Join Hercule Poirot as he investigates a murder on a luxurious cruise ship sailing down the Nile River.',
  ),
  CardItem(
    ...
    description:
        'A classic detective fiction by Agatha Christie, featuring Hercule Poirot as the brilliant detective on the Orient Express.',
  ),
  CardItem(
    title: 'And Then There Were None',
    price: "€11.49",
